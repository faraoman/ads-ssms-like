...
export async function RunExec(connection: azdata.IConnectionProfile, query: string): Promise<azdata.SimpleExecuteResult> {
    ...
    if (connectionResult.connected) {
        ...
        try {
            await queryProvider.runQueryString(connectionUri, query);
            result = {
